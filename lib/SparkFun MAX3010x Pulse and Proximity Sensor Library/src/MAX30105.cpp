/***************************************************
  This is a library written for the Maxim Sparkfun_MAX30105 Optical Smoke Detector
...
Sparkfun_MAX30105::Sparkfun_MAX30105() {
  // Constructor
}

boolean Sparkfun_MAX30105::begin(TwoWire &wirePort, uint32_t i2cSpeed, uint8_t i2caddr) {
  ...
  // Check that a Sparkfun_MAX30105 is connected
  if (readPartID() != MAX_30105_EXPECTEDPARTID) {
    // Error -- Part ID read from Sparkfun_MAX30105 does not match expected part ID.
...
void Sparkfun_MAX30105::shutDown(void) {
...
void Sparkfun_MAX30105::wakeUp(void) {
  // Pull IC out of low power mode (datasheet pg. 19)
  bitMask(MAX30105_MODECONFIG, MAX30105_SHUTDOWN_MASK, MAX30105_WAKEUP);
}

void Sparkfun_MAX30105::setLEDMode(uint8_t mode) {
  // Set which LEDs are used for sampling -- Red only, RED+IR only, or custom.
  // See datasheet, page 19
  bitMask(MAX30105_MODECONFIG, MAX30105_MODE_MASK, mode);
}

void Sparkfun_MAX30105::setADCRange(uint8_t adcRange) {
  // adcRange: one of MAX30105_ADCRANGE_2048, _4096, _8192, _16384
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_ADCRANGE_MASK, adcRange);
}

void Sparkfun_MAX30105::setSampleRate(uint8_t sampleRate) {
  // sampleRate: one of MAX30105_SAMPLERATE_50, _100, _200, _400, _800, _1000, _1600, _3200
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_SAMPLERATE_MASK, sampleRate);
}

void Sparkfun_MAX30105::setPulseWidth(uint8_t pulseWidth) {
...
void Sparkfun_MAX30105::setPulseAmplitudeRed(uint8_t amplitude) {
  writeRegister8(_i2caddr, MAX30105_LED1_PULSEAMP, amplitude);
}

void Sparkfun_MAX30105::setPulseAmplitudeIR(uint8_t amplitude) {
  writeRegister8(_i2caddr, MAX30105_LED2_PULSEAMP, amplitude);
}

void Sparkfun_MAX30105::setPulseAmplitudeGreen(uint8_t amplitude) {
  writeRegister8(_i2caddr, MAX30105_LED3_PULSEAMP, amplitude);
}

void Sparkfun_MAX30105::setPulseAmplitudeProximity(uint8_t amplitude) {
  writeRegister8(_i2caddr, MAX30105_LED_PROX_AMP, amplitude);
}

void Sparkfun_MAX30105::setProximityThreshold(uint8_t threshMSB) {
...
void Sparkfun_MAX30105::enableSlot(uint8_t slotNumber, uint8_t device) {
...
void Sparkfun_MAX30105::disableSlots(void) {
...
void Sparkfun_MAX30105::setFIFOAverage(uint8_t numberOfSamples) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_SAMPLEAVG_MASK, numberOfSamples);
}

//Resets all points to start in a known state
//Page 15 recommends clearing FIFO before beginning a read
void Sparkfun_MAX30105::clearFIFO(void) {
...
void Sparkfun_MAX30105::enableFIFORollover(void) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_ROLLOVER_MASK, MAX30105_ROLLOVER_ENABLE);
}

//Disable roll over if FIFO over flows
void Sparkfun_MAX30105::disableFIFORollover(void) {
...
void Sparkfun_MAX30105::setFIFOAlmostFull(uint8_t numberOfSamples) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_A_FULL_MASK, numberOfSamples);
}

//Read the FIFO Write Pointer
uint8_t Sparkfun_MAX30105::getWritePointer(void) {
  return (readRegister8(_i2caddr, MAX30105_FIFOWRITEPTR));
}

//Read the FIFO Read Pointer
uint8_t Sparkfun_MAX30105::getReadPointer(void) {
...
// Die Temperature
// Returns temp in C
float Sparkfun_MAX30105::readTemperature() {
...
float Sparkfun_MAX30105::readTemperatureF() {
...
void Sparkfun_MAX30105::setPROXINTTHRESH(uint8_t val) {
...
//
uint8_t Sparkfun_MAX30105::readPartID() {
  return readRegister8(_i2caddr, MAX30105_PARTID);
}

void Sparkfun_MAX30105::readRevisionID() {
  revisionID = readRegister8(_i2caddr, MAX30105_REVISIONID);
}

uint8_t Sparkfun_MAX30105::getRevisionID() {
  return revisionID;
}


//Setup the sensor
//The Sparkfun_MAX30105 has many settings. By default we select:
// Sample Average = 4
// Mode = MultiLED
// ADC Range = 16384 (62.5pA per LSB)
// Sample rate = 50
//Use the default setup if you are just getting started with the Sparkfun_MAX30105 sensor
void Sparkfun_MAX30105::setup(byte powerLevel, byte sampleAverage, byte ledMode, int sampleRate, int pulseWidth, int adcRange) {
...
uint8_t Sparkfun_MAX30105::available(void)
{
...
uint32_t Sparkfun_MAX30105::getRed(void)
{
...
uint32_t Sparkfun_MAX30105::getIR(void)
{
  //Check the sensor for new data for 250ms
  if(safeCheck(250))
...
uint32_t Sparkfun_MAX30105::getGreen(void)
{
  //Check the sensor for new data for 250ms
  if(safeCheck(250))
...
uint32_t Sparkfun_MAX30105::getFIFORed(void)
{
  return (sense.red[sense.tail]);
}

//Report the next IR value in the FIFO
uint32_t Sparkfun_MAX30105::getFIFOIR(void)
{
  return (sense.IR[sense.tail]);
}

//Report the next Green value in the FIFO
uint32_t Sparkfun_MAX30105::getFIFOGreen(void)
{
  return (sense.green[sense.tail]);
}

//Advance the tail
void Sparkfun_MAX30105::nextSample(void)
{
...
uint16_t Sparkfun_MAX30105::check(void)
{
...
bool Sparkfun_MAX30105::safeCheck(uint8_t maxTimeToCheck)
{
...
void Sparkfun_MAX30105::bitMask(uint8_t reg, uint8_t mask, uint8_t thing)
{
...
//
uint8_t Sparkfun_MAX30105::readRegister8(uint8_t address, uint8_t reg) {
...
void Sparkfun_MAX30105::writeRegister8(uint8_t address, uint8_t reg, uint8_t value) {
  _i2cPort->beginTransmission(address);
  _i2cPort->write(reg);
