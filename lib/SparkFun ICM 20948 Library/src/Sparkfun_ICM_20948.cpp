...
// Base
Sparkfun_ICM_20948::Sparkfun_ICM_20948()
{
  status = ICM_20948_init_struct(&_device);
}

void Sparkfun_ICM_20948::enableDebugging(Stream &debugPort)
{
  _debugSerial = &debugPort; //Grab which port the user wants us to use for debugging
  _printDebug = true;        //Should we print the commands we send? Good for debugging
}
void Sparkfun_ICM_20948::disableDebugging(void)
{
...
void Sparkfun_ICM_20948::debugPrint(const char *line)
{
  doDebugPrint([](const char *ptr) { return *ptr; }, line);
}

void Sparkfun_ICM_20948::debugPrint(const __FlashStringHelper *line)
{
  doDebugPrint([](const char *ptr) { return (char)pgm_read_byte_near(ptr); },
               (const char *)line);
}

void Sparkfun_ICM_20948::debugPrintln(const char *line)
{
  doDebugPrint([](const char *ptr) { return *ptr; }, line, true);
}

void Sparkfun_ICM_20948::debugPrintln(const __FlashStringHelper *line)
{
  doDebugPrint([](const char *ptr) { return (char)pgm_read_byte_near(ptr); },
               (const char *)line, true);
}

void Sparkfun_ICM_20948::doDebugPrint(char (*funct)(const char *), const char *string, bool newLine)
{
...
void Sparkfun_ICM_20948::debugPrintf(int i)
{
  if (_printDebug == true)
    _debugSerial->print(i);
}

void Sparkfun_ICM_20948::debugPrintf(float f)
{
  if (_printDebug == true)
    _debugSerial->print(f);
}

void Sparkfun_ICM_20948::debugPrintStatus(ICM_20948_Status_e stat)
{
  switch (stat)
  {
...
ICM_20948_AGMT_t Sparkfun_ICM_20948::getAGMT(void)
{
...
float Sparkfun_ICM_20948::magX(void)
{
  return getMagUT(agmt.mag.axes.x);
}

float Sparkfun_ICM_20948::magY(void)
{
  return getMagUT(agmt.mag.axes.y);
}

float Sparkfun_ICM_20948::magZ(void)
{
  return getMagUT(agmt.mag.axes.z);
}

float Sparkfun_ICM_20948::getMagUT(int16_t axis_val)
{
  return (((float)axis_val) * 0.15);
}

float Sparkfun_ICM_20948::accX(void)
{
  return getAccMG(agmt.acc.axes.x);
}

float Sparkfun_ICM_20948::accY(void)
{
  return getAccMG(agmt.acc.axes.y);
}

float Sparkfun_ICM_20948::accZ(void)
{
  return getAccMG(agmt.acc.axes.z);
}

float Sparkfun_ICM_20948::getAccMG(int16_t axis_val)
{
  switch (agmt.fss.a)
  {
  case 0:
...
float Sparkfun_ICM_20948::gyrX(void)
{
  return getGyrDPS(agmt.gyr.axes.x);
}

float Sparkfun_ICM_20948::gyrY(void)
{
  return getGyrDPS(agmt.gyr.axes.y);
}

float Sparkfun_ICM_20948::gyrZ(void)
{
  return getGyrDPS(agmt.gyr.axes.z);
}

float Sparkfun_ICM_20948::getGyrDPS(int16_t axis_val)
{
  switch (agmt.fss.g)
  {
  case 0:
...
//Gyro Bias
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasGyroX( int32_t newValue)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasGyroY( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char gyro_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasGyroZ( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char gyro_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasGyroX( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasGyroY( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasGyroZ( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
//Accel Bias
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasAccelX( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasAccelY( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char accel_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasAccelZ( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char accel_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasAccelX( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasAccelY( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasAccelZ( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
//CPass Bias
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasCPassX( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasCPassY( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char cpass_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::setBiasCPassZ( int32_t newValue)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char cpass_bias_reg[4];
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasCPassX( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasCPassY( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
ICM_20948_Status_e Sparkfun_ICM_20948::getBiasCPassZ( int32_t* bias)
{
  if (_device._dmp_firmware_available == true) // Is DMP supported?
  {
    unsigned char bias_data[4] = { 0 };
...
float Sparkfun_ICM_20948::temp(void)
{
  return getTempC(agmt.tmp.val);
}

float Sparkfun_ICM_20948::getTempC(int16_t val)
{
  return (((float)val - 21) / 333.87) + 21;
}

const char *Sparkfun_ICM_20948::statusString(ICM_20948_Status_e stat)
{
...
// Device Level
ICM_20948_Status_e Sparkfun_ICM_20948::setBank(uint8_t bank)
{
  status = ICM_20948_set_bank(&_device, bank);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::swReset(void)
{
  status = ICM_20948_sw_reset(&_device);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::sleep(bool on)
{
  status = ICM_20948_sleep(&_device, on);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::lowPower(bool on)
{
  status = ICM_20948_low_power(&_device, on);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::setClockSource(ICM_20948_PWR_MGMT_1_CLKSEL_e source)
{
  status = ICM_20948_set_clock_source(&_device, source);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::checkID(void)
{
  status = ICM_20948_check_id(&_device);
  if (status != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::checkID: ICM_20948_check_id returned: "));
...
bool Sparkfun_ICM_20948::dataReady(void)
{
...
uint8_t Sparkfun_ICM_20948::getWhoAmI(void)
{
  uint8_t retval = 0x00;
...
bool Sparkfun_ICM_20948::isConnected(void)
{
  status = checkID();
  if (status == ICM_20948_Stat_Ok)
  {
  ...
  debugPrint(F("Sparkfun_ICM_20948::isConnected: checkID returned: "));
  debugPrintStatus(status);
  debugPrintln(F(""));
  return false;
}
...
ICM_20948_Status_e Sparkfun_ICM_20948::setSampleMode(uint8_t sensor_id_bm, uint8_t lp_config_cycle_mode)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::setFullScale(uint8_t sensor_id_bm, ICM_20948_fss_t fss)
{
  status = ICM_20948_set_full_scale(&_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, fss);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::setDLPFcfg(uint8_t sensor_id_bm, ICM_20948_dlpcfg_t cfg)
{
  status = ICM_20948_set_dlpf_cfg(&_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, cfg);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::enableDLPF(uint8_t sensor_id_bm, bool enable)
{
  status = ICM_20948_enable_dlpf(&_device, (ICM_20948_InternalSensorID_bm)sensor_id_bm, enable);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::setSampleRate(uint8_t sensor_id_bm, ICM_20948_smplrt_t smplrt)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::clearInterrupts(void)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgIntActiveLow(bool active_low)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgIntOpenDrain(bool open_drain)
{
  ICM_20948_INT_PIN_CFG_t reg;
  status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgIntLatch(bool latching)
{
  ICM_20948_INT_PIN_CFG_t reg;
  status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgIntAnyReadToClear(bool enabled)
{
  ICM_20948_INT_PIN_CFG_t reg;
  status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgFsyncActiveLow(bool active_low)
{
  ICM_20948_INT_PIN_CFG_t reg;
  status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::cfgFsyncIntMode(bool interrupt_mode)
{
  ICM_20948_INT_PIN_CFG_t reg;
  status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableI2C(bool enable)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableDMP(bool enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnablePLL(bool enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableWOM(bool enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableWOF(bool enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableRawDataReady(bool enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableOverflowFIFO(uint8_t bm_enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::intEnableWatermarkFIFO(uint8_t bm_enable)
{
  ICM_20948_INT_enable_t en;                          // storage
  status = ICM_20948_int_enable(&_device, NULL, &en); // read phase
  if (status != ICM_20948_Stat_Ok)
...
ICM_20948_Status_e Sparkfun_ICM_20948::WOMLogic(uint8_t enable, uint8_t mode)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::WOMThreshold(uint8_t threshold)
{
...
// Interface Options
ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterPassthrough(bool passthrough)
{
  status = ICM_20948_i2c_master_passthrough(&_device, passthrough);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterEnable(bool enable)
{
  status = ICM_20948_i2c_master_enable(&_device, enable);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterReset()
{
  status = ICM_20948_i2c_master_reset(&_device);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::i2cControllerConfigurePeripheral(uint8_t peripheral, uint8_t addr, uint8_t reg, uint8_t len, bool Rw, bool enable, bool data_only, bool grp, bool swap, uint8_t dataOut)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterConfigureSlave(uint8_t peripheral, uint8_t addr, uint8_t reg, uint8_t len, bool Rw, bool enable, bool data_only, bool grp, bool swap)
{
  return (i2cControllerConfigurePeripheral(peripheral, addr, reg, len, Rw, enable, data_only, grp, swap, 0));
}

ICM_20948_Status_e Sparkfun_ICM_20948::i2cControllerPeriph4Transaction(uint8_t addr, uint8_t reg, uint8_t *data, uint8_t len, bool Rw, bool send_reg_addr)
{
...
//Provided for backward-compatibility only. Please update to i2cControllerConfigurePeripheral and i2cControllerPeriph4Transaction.
//https://www.oshwa.org/2020/06/29/a-resolution-to-redefine-spi-pin-names/
ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterSLV4Transaction(uint8_t addr, uint8_t reg, uint8_t *data, uint8_t len, bool Rw, bool send_reg_addr)
{
  return (i2cControllerPeriph4Transaction(addr, reg, data, len, Rw, send_reg_addr));
}

ICM_20948_Status_e Sparkfun_ICM_20948::i2cMasterSingleW(uint8_t addr, uint8_t reg, uint8_t data)
{
  status = ICM_20948_i2c_master_single_w(&_device, addr, reg, &data);
  return status;
}
uint8_t Sparkfun_ICM_20948::i2cMasterSingleR(uint8_t addr, uint8_t reg)
{
  uint8_t data = 0;
  status = ICM_20948_i2c_master_single_r(&_device, addr, reg, &data);
  if (status != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::i2cMasterSingleR: ICM_20948_i2c_master_single_r returned: "));
    debugPrintStatus(status);
    debugPrintln(F(""));
  }
  return data;
...
ICM_20948_Status_e Sparkfun_ICM_20948::startupDefault(bool minimal)
{
  ...
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: checkID returned: "));
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: swReset returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: sleep returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: lowPower returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: startupMagnetometer returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  {
    debugPrintln(F("Sparkfun_ICM_20948::startupDefault: minimal startup complete!"));
    return status;
  }
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: setSampleMode returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: setFullScale returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: setDLPFcfg returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: enableDLPF (Acc) returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDefault: enableDLPF (Gyr) returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
...
// direct read/write
ICM_20948_Status_e Sparkfun_ICM_20948::read(uint8_t reg, uint8_t *pdata, uint32_t len)
{
  status = ICM_20948_execute_r(&_device, reg, pdata, len);
  return (status);
}

ICM_20948_Status_e Sparkfun_ICM_20948::write(uint8_t reg, uint8_t *pdata, uint32_t len)
{
  status = ICM_20948_execute_w(&_device, reg, pdata, len);
  return (status);
}

uint8_t Sparkfun_ICM_20948::readMag(AK09916_Reg_Addr_e reg)
{
  uint8_t data = i2cMasterSingleR(MAG_AK09916_I2C_ADDR, reg); // i2cMasterSingleR updates status too
  return data;
}

ICM_20948_Status_e Sparkfun_ICM_20948::writeMag(AK09916_Reg_Addr_e reg, uint8_t *pdata)
{
  status = i2cMasterSingleW(MAG_AK09916_I2C_ADDR, reg, *pdata);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::resetMag()
{
  uint8_t SRST = 1;
  // SRST: Soft reset
  // “0”: Normal
...
ICM_20948_Status_e Sparkfun_ICM_20948::enableFIFO(bool enable)
{
  status = ICM_20948_enable_FIFO(&_device, enable);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::resetFIFO(void)
{
  status = ICM_20948_reset_FIFO(&_device);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::setFIFOmode(bool snapshot)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::getFIFOcount(uint16_t *count)
{
  status = ICM_20948_get_FIFO_count(&_device, count);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::readFIFO(uint8_t *data, uint8_t len)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::enableDMP(bool enable)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::resetDMP(void)
{
  status = ICM_20948_reset_DMP(&_device);
  return status;
}

ICM_20948_Status_e Sparkfun_ICM_20948::loadDMPFirmware(void)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::setDMPstartAddress(unsigned short address)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::enableDMPSensor(enum inv_icm20948_sensor sensor, bool enable)
{
  if (_device._dmp_firmware_available == true) // Should we attempt to enable the sensor?
  {
    ...
    debugPrint(F("Sparkfun_ICM_20948::enableDMPSensor:  _enabled_Android_0: "));
...
ICM_20948_Status_e Sparkfun_ICM_20948::enableDMPSensorInt(enum inv_icm20948_sensor sensor, bool enable)
{
  if (_device._dmp_firmware_available == true) // Should we attempt to enable the sensor interrupt?
  {
    ...
    debugPrint(F("Sparkfun_ICM_20948::enableDMPSensorInt:  _enabled_Android_intr_0: "));
...
ICM_20948_Status_e Sparkfun_ICM_20948::writeDMPmems(unsigned short reg, unsigned int length, const unsigned char *data)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::readDMPmems(unsigned short reg, unsigned int length, unsigned char *data)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::setDMPODRrate(enum DMP_ODR_Registers odr_reg, int interval)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::readDMPdataFromFIFO(icm_20948_DMP_data_t *data)
{
...
ICM_20948_Status_e Sparkfun_ICM_20948::setGyroSF(unsigned char div, int gyro_level)
{
  if (_device._dmp_firmware_available == true) // Should we attempt to set the Gyro SF?
  {
    ...
    debugPrint(F("Sparkfun_ICM_20948::setGyroSF:  pll: "));
...
ICM_20948_Status_e Sparkfun_ICM_20948::initializeDMP(void)
{
  // First, let's check if the DMP is available
  if (_device._dmp_firmware_available != true)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupDMP: DMP is not available. Please check that you have uncommented line 29 (#define ICM_20948_USE_DMP) in ICM_20948_C.h..."));
    return ICM_20948_Stat_DMPNotSupported;
  }
...
// I2C
Sparkfun_ICM_20948_I2C::Sparkfun_ICM_20948_I2C()
{
}

ICM_20948_Status_e Sparkfun_ICM_20948_I2C::begin(TwoWire &wirePort, bool ad0val, uint8_t ad0pin)
{
  // Associate
  _ad0 = ad0pin;
  _i2c = &wirePort;
  ...
  if (status != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948_I2C::begin: startupDefault returned: "));
    debugPrintStatus(status);
    debugPrintln(F(""));
  }
  return status;
...
ICM_20948_Status_e Sparkfun_ICM_20948::startupMagnetometer(bool minimal)
{
  ICM_20948_Status_e retval = ICM_20948_Stat_Ok;
  ...
  {
    debugPrint(F("Sparkfun_ICM_20948::startupMagnetometer: reached MAX_MAGNETOMETER_STARTS ("));
  ...
  {
    debugPrint(F("Sparkfun_ICM_20948::startupMagnetometer: successful magWhoIAm after "));
  ...
  if (minimal) // Return now if minimal is true
  {
    debugPrintln(F("Sparkfun_ICM_20948::startupMagnetometer: minimal startup complete!"));
    return status;
  }
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupMagnetometer: writeMag returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::startupMagnetometer: i2cMasterConfigurePeripheral returned: "));
    debugPrintStatus(retval);
    debugPrintln(F(""));
    status = retval;
    return status;
...
ICM_20948_Status_e Sparkfun_ICM_20948::magWhoIAm(void)
{
  ICM_20948_Status_e retval = ICM_20948_Stat_Ok;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    debugPrint(F("Sparkfun_ICM_20948::magWhoIAm: whoiam1: "));
...
ICM_20948_Status_e ICM_20948_write_I2C(uint8_t reg, uint8_t *data, uint32_t len, void *user)
{
  ...
  TwoWire *_i2c = ((Sparkfun_ICM_20948_I2C *)user)->_i2c; // Cast user field to Sparkfun_ICM_20948_I2C type and extract the I2C interface pointer
  uint8_t addr = ((Sparkfun_ICM_20948_I2C *)user)->_addr;
  if (_i2c == NULL)
  {
    return ICM_20948_Stat_ParamErr;
  }
...
ICM_20948_Status_e ICM_20948_read_I2C(uint8_t reg, uint8_t *buff, uint32_t len, void *user)
{
  ...
  TwoWire *_i2c = ((Sparkfun_ICM_20948_I2C *)user)->_i2c;
  uint8_t addr = ((Sparkfun_ICM_20948_I2C *)user)->_addr;
  if (_i2c == NULL)
  {
    return ICM_20948_Stat_ParamErr;
